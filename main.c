 ...
 * Author: 佐々木翔
 *
 * Created on 2021/11/07, 11:17
 * Discription　実装試験3の姿勢制御系のプログラム
 * 編集履歴
 * 2021/11/07：初版
 * 
 */
...
volatile char data[8] = {3, 0, 0, 0, 0, 0, 0, 1};                               //HKデータ
